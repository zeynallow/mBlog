<div class="row">
  ...
  <div class="col-md-4">
    <div class="text-center">
      ...
      <button class="btn btn-primary" onclick="performCrop()">{{ trans('lfm.btn-crop') }}</button>
      <button class="btn btn-primary" onclick="performCropNew()">{{ trans('lfm.btn-copy-crop') }}</button>
