  ...
  <div class="blog-area blog-details pt-40 pb-120 clearfix">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 mobi-mb-50">

          <div class="i-blog-post clearfix pt-40">
            <div class="row pb-50">
              <div class="col-xs-12">
              ...
              <div class="comment-box">
                ...
                @if(auth()->check())
                  <form class="custom-input" action="{{ route('post.commentStore') }}" method="post">
                    ...
                    <textarea required name="body" id="comment" rows="2" placeholder="@lang('site.your_comment')"></textarea>
